...
"""
this file is for pagination module we are adding new functionalities for reviews and products pagination,
just copied the flask-pagination init library and added new function get_page_args_for_reviews
"""
# !/usr/bin/env python
# -*- coding: utf-8 -*-
...
def get_page_args_for_reviews(
    ...
    per_page = args.get(per_page_name, type=int)
    if not per_page:
        per_page = int(current_app.config.get(per_page_name.upper(), 3))
    else:
        per_page = int(per_page)
